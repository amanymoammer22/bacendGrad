...
exports.createProductValidator = [
    ...
    check("price").notEmpty().withMessage("Product price is required").isNumeric().withMessage("Product price must be a number")
        .custom(val => {
        if (val > 2000) throw new Error("Too long product price");
        return true;
        })
    ...
    check("size").optional().isArray().withMessage("availableSizes should be array of string"),
